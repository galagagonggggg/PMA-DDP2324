...
def case_counter(text):
    ...
    upper_case_list = [x.upper() for x in lower_case_list]

    for i in text:
        if i in lower_case_list:
            lower_case_count += 1
        elif i in upper_case_list:
            upper_case_count += 1
    
    return print(f"Expected: Uppercase letters: {upper_case_count}, Lowercase letters: {lower_case_count}")
